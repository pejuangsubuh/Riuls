...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" FARCHAN ANUGRAH  [FR13ND8]"$i"         |"
echo $i" |"$pu" FACEBOOK :"$ku" farchan anugrah"$i"                  |"
...
echo $i" |"$pu" Contack Gmail :"$ku" farchanriul@gmail.com"$i"       |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
pkg install nano
figlet -f slant " O k s u c e s "|lolcat
fi
...
sleep 2
echo $ku"WhatsApp :"$i" 081802899155"
echo $ku"Facebook :"$i" farchan anugrah"
sleep 2
